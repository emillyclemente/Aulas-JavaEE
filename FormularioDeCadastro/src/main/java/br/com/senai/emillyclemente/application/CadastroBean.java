...
import br.com.senai.emillyclemente.model.Linguagem;

@SuppressWarnings("serial")
@RequestScoped
@Named("cadastro")//Como o bean vai ser chamado
public class CadastroBean implements Serializable {
	...
	public Linguagem[] getListaLinguagens() { //Chamando a constante Linguagens para o bean
	...
	public String getLinguagensAsString() {  //Mostrar as linguagens como String, colocando uma virgula caso haja mais de uma (validação)
		String str="";
		boolean first = true;
